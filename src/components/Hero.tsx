    ...
    <section className="relative overflow-hidden bg-gradient-to-b from-blue-50 via-blue-50/50 to-white dark:from-gray-900 dark:to-background">
      ...
      <div className="container-custom section-padding flex flex-col items-center text-center relative z-10">
        <div className="animate-blur-in mx-auto max-w-3xl space-y-6">
          <div className="inline-block rounded-full bg-gradient-to-r from-blue-100 to-blue-200 px-4 py-1.5 text-sm font-medium text-blue-800 shadow-sm dark:bg-blue-900/30 dark:text-blue-300 animate-fade-in">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl md:text-6xl lg:text-7xl animate-slide-in" style={{ animationDelay: '0.2s' }}>
            Turn Unused Software <span className="text-gradient animate-gradient">Into Cash</span>
          </h1>
          ...
          <div className="mt-10 flex flex-col sm:flex-row gap-6 justify-center animate-fade-in" style={{ animationDelay: '0.6s' }}>
            <Button size="lg" className="rounded-full px-8 shadow-md hover:shadow-glow transition-all btn-pulse">
              Sell My Licenses
            </Button>
            <Button size="lg" variant="outline" className="rounded-full px-8 border-2 hover:bg-blue-50 dark:hover:bg-blue-900/20 hover-lift">
              Learn More
            </Button>
          </div>
        </div>
